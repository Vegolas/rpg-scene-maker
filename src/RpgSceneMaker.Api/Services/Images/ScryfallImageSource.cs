...
namespace RpgSceneMaker.Api.Services.Images;
...
public sealed class ScryfallImageSource : IImageSearchSource
{
    ...
    public ScryfallImageSource(HttpClient http, IMemoryCache cache)
    {
        ...
        _http.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("RpgSceneMaker", "1.0"));
        _http.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("(+https://github.com/Vegolas/rpg-scene-maker)"));
